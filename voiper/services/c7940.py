...
# Line 1 Settings
line1_name: "{{ data['number_1'] }}"                ; Line 1 Extension - User ID
line1_displayname: "{{ data['number_1'] }}"         ; Line 1 Display Name
line1_authname: "{{ data['number_1'] }}"            ; Line 1 Registration Authentication
line1_password: "{{ data['secret_1'] }}" ; Line 1 Registration Password

# Line 2 Settings
line2_name: "{{ data['number_2'] }}"                      ; Line 2 Extension - User ID
line2_displayname: "{{ data['number_2'] }}"                   ; Line 2 Display Name
line2_authname: "{{ data['number_2'] }}"         ; Line 2 Registration Authentication
line2_password: "{{ data['secret_2'] }}"         ; Line 2 Registration Password
...
phone_label: "{{ data['provider'] }}"            ; Has no effect on SIP messaging
...
phone_prompt: "{{ data['phone_prompt'] }}"                              ; Telnet/Console Prompt
phone_password: "{{ data['secret'] }}"                          ; Telnet/Console Password
