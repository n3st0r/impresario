...
<flat-profile xmlns="http://www.sipura.net/xsd/PAP2T" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.sipura.net/xsd/PAP2T http://www.sipura.net/xsd/PAP2T/PAP2T-5-1-6-LS.xsd">
  ...
  <Resync_Periodic ua="na">600</Resync_Periodic>
  <Resync_Error_Retry_Delay ua="na">600</Resync_Error_Retry_Delay>
  ...
  <Resync_Fails_On_FNF ua="na">No</Resync_Fails_On_FNF>
  <Profile_Rule ua="na">{{ data['provisioning_rule'] }}</Profile_Rule>
  ...
  <Upgrade_Rule ua="na">{{ data['upgrade_rule'] }}</Upgrade_Rule>
  ...
  <Softswitch_Features ua="na"></Softswitch_Features>
  ...
  <Auth_MWI_1_ ua="na">No</Auth_MWI_1_>
  ...
  <Proxy_1_ ua="na">{{ data['sip_proxy'] }}</Proxy_1_>
  <Use_Outbound_Proxy_1_ ua="na">No</Use_Outbound_Proxy_1_>
  <Outbound_Proxy_1_ ua="na">{{ data['sip_proxy'] }}</Outbound_Proxy_1_>
  ...
  <Display_Name_1_ ua="na">{{ data['number_1'] }}</Display_Name_1_>
  <User_ID_1_ ua="na">{{ data['number_1'] }}</User_ID_1_>
  <Password_1_ ua="na">{{ data['secret_1'] }}</Password_1_>
  ...
  <Call_Waiting_Serv_1_ ua="na">No</Call_Waiting_Serv_1_>
  ...
  <FAX_Passthru_Method_1_ ua="na">NSE</FAX_Passthru_Method_1_>
  ...
  <Dial_Plan_1_ ua="na">{{ data['dialplan_1'] }}</Dial_Plan_1_>
  ...
  <DND_Activated_1_ ua="rw">No</DND_Activated_1_>
  ...
  <Jitter_Buffer_Adjustment_2_ ua="na">up and down</Jitter_Buffer_Adjustment_2_>
  ...
  <Auth_MWI_2_ ua="na">No</Auth_MWI_2_>
  ...
  <Proxy_2_ ua="na">{{ data['sip_proxy'] }}</Proxy_2_>
  <Use_Outbound_Proxy_2_ ua="na">No</Use_Outbound_Proxy_2_>
  <Outbound_Proxy_2_ ua="na">{{ data['sip_proxy'] }}</Outbound_Proxy_2_>
  ...
  <Display_Name_2_ ua="na">{{ data['number_2'] }}</Display_Name_2_>
  <User_ID_2_ ua="na">{{ data['number_2'] }}</User_ID_2_>
  <Password_2_ ua="na">{{ data['secret_2'] }}</Password_2_>
  ...
  <Call_Waiting_Serv_2_ ua="na">No</Call_Waiting_Serv_2_>
  ...
  <FAX_Passthru_Method_2_ ua="na">NSE</FAX_Passthru_Method_2_>
  ...
  <Dial_Plan_2_ ua="na">{{ data['dialplan_2'] }}</Dial_Plan_2_>
  ...
  <DND_Activated_2_ ua="rw">No</DND_Activated_2_>
  ...
  <DND_Dial_Tone ua="na">350@-19,440@-19;2(.2/.2/2);10(*/0/1+2)</DND_Dial_Tone>
  ...
  <Cfwd_All_Act_Code ua="na">*21*</Cfwd_All_Act_Code>
  <Cfwd_All_Deact_Code ua="na">#21#</Cfwd_All_Deact_Code>
  ...
  <FXS_Port_Impedance ua="na">270+750||150nF</FXS_Port_Impedance>
  ...
  <Caller_ID_Method ua="na">ETSI DTMF After Ring</Caller_ID_Method>
  <FXS_Port_Power_Limit ua="na">3</FXS_Port_Power_Limit>
